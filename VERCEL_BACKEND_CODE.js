// ===================================================
// SSAAM VERCEL BACKEND - Complete Code
// Copy and paste this into your Vercel backend (api/index.js or similar)
// This file includes ALL endpoints for the SSAAM frontend
// ===================================================
...
// GET statistics - dashboard counters (all students by program/year)
...
app.post('/apis/students', studentAuth, async (req, res) => {
    ...
    const full_name = `${data.first_name} ${data.middle_name || ""} ${data.last_name} ${data.suffix || ""}`.replace(/\s+/g, " ").trim();
